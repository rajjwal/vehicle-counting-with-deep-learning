...
def detect_objects(image_np, sess, detection_graph):
    ...
    path_to_records = os.path.join(os.getcwd(), 'recorded_vehicles_000.txt')
    recording_objects_utils.record_vehicles(image_np, 
                                            np.squeeze(boxes), 
...
if __name__ == '__main__':
    ...
    parser.add_argument('-src', '--source', dest='video_source', type=str,
                        default="data/CarVideoI.mp4", help='Device index of the camera.')
